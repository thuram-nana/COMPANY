...
const copy = {
  en: {
    title: "How we build",
    description: "The doctrine of SIGIL SARL, Buea, Cameroon: capability is never authorization, no finding is trusted until re-verified, and the institution holds the keys.",
    lede: 'One doctrine runs through all three systems — <a href="/systems/vigil/">VIGIL</a>, <a href="/systems/recor/">RÉCOR</a>, and <a href="/systems/apex/">APEX</a>. It is written as things you can verify, not things you have to believe. Each principle below is a claim an evaluator can test against the system in front of them.',
    principles: [
      ...
      ["Open standards, not lock-in", 'Where a standard exists, we build to it and export to it — so the institution\'s data is portable and outlives any one vendor. <a href="/systems/recor/">RÉCOR, the sovereign beneficial-ownership registry,</a> exports to the Beneficial Ownership Data Standard; our systems ship signed builds with a software bill of materials.'],
  ...
  fr: {
    title: "Notre méthode",
    description: "Doctrine de SIGIL SARL (Buea, Cameroun) : une capacité n’est jamais une autorisation, aucun constat sans re-vérification, l’institution détient les clés.",
    lede: 'Une même doctrine traverse les trois systèmes — <a href="/fr/systemes/vigil/">VIGIL</a>, <a href="/fr/systemes/recor/">RÉCOR</a> et <a href="/fr/systemes/apex/">APEX</a>. Elle est écrite comme des choses vérifiables, non comme des choses à croire. Chaque principe ci-dessous est une affirmation qu’un évaluateur peut tester sur le système qu’il a devant lui.',
    principles: [
      ...
      ["Standards ouverts, pas de verrouillage", 'Lorsqu’un standard existe, nous le respectons et exportons vers lui — pour que les données de l’institution soient portables et survivent à tout fournisseur unique. <a href="/fr/systemes/recor/">RÉCOR, le registre souverain des bénéficiaires effectifs,</a> exporte vers le standard de données sur les bénéficiaires effectifs ; nos systèmes livrent des builds signés avec une nomenclature logicielle.'],
